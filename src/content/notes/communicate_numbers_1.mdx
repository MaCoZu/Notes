...
confronted with the suffering of thousands, it becomes abstract, and our ability to empathize is diminished. Sobering fact: the reduction in empathy begins as soon as we get past 1 person and begin thinking about 2 instead. The following techniques can counteract that to some extend.
...
#### Concrete Units  
Units can be too abstartc sometimes. Turn units like a "microsecond" into something demonstrable.
