...
### 1. Abbe Principle  
<span class="em">Measure things so that the measuring scale is aligned with the distance being measured.</span>

The so-called Abbe error is a measurement error that is amplified by distance. The Abbe principle applies narrowly to taking physical measurements that minimize angular error, but it can be used in other contexts. 
...
### 2. Accessibility
<span class="em">Things should be designed to be usable, without modification, by as many people as possible.</span>
...
### 3. Ackoff’s Law 
<span class="em">It is better to do the right things wrong than the wrong things right.</span>
...
<span class="em">Aesthetic things are subjectively perceived as easier to use than ugly ones.</span>
...
### 5. Affordance  
<span class="em">The physical characteristics of a thing that influence its function and use.</span>
...
### 6. Alignment  
<span class="em">The arrangement of elements along a common axis based on their edges, centers, or areas.</span>

<div class="">
<p class="mx-20 text-justify">Aligning elements creates compositional unity and cohesion which improves aesthetic and perceived stability of a design. It also helps users understand the designs its function and in processing information.</p>

<p class="mx-20 text-justify">Elements are often aligned by their edges and axes in symmetry or balancing their perceived weight. This is sometimes better done by eye rather than strict rules, especially if the elements have irregular shapes. </p>
...
### 7. Anchoring  
<span class="em">The subconscious influence of reference points on decision-making and judgment.</span>

Most research on anchoring regards to numbers. For example a car is perceived to be cheaper when placed next to an expensive one (the anchor), even if the two cars are incomparable. But not just the first impression is an anchor, people also cling to the last stimuli shown to them ("end anchoring"), while things in between have less influence.

<div class="text-center">
<span class="text-6xl font-typewriter">\$2000</span>
<span class="text-xl font-typewriter"> \$1800 </span>
<span class="text-xl font-typewriter"> \$1500 </span>
<span class="text-xl font-typewriter"> \$1200 </span>
<span class="text-6xl font-typewriter">\$1000</span>
</div>

The effect does not only apply to numbers but any stimulus perceptible by the senses. Once the value of the anchor is set, subsequent arguments, estimates, etc. made by an individual may change from what they would have otherwise been without the anchor. 

Consider anchoring in the presentation of options and experiences, especially in decision-making and judgment contexts. When presenting stimuli sequentially, the initial stimulus sets the anchor. When presenting stimuli together, the low and high stimuli set the low and high anchors. 


### 8. Anthropomorphism  
<span class="em">The attribution of humanlike characteristics to nonhuman things.</span>

Humans are predisposed to perceive certain forms and patterns as humanlike — specifically, forms and patterns that resemble faces and body proportions. In design this is an effective means to getting attention and a positive feedback, if done artfully.

Personal robot assistants are examples of visual anthropomorphism (standing upright, friendly faces). Similarly are large language models and speaking AI’s often equipped with humanlike communication skills.

Favor more abstract anthropomorphic forms, as realistic depictions often decrease, aesthetic appeal. Use feminine body proportions to elicit associations of sexuality and vitality. Use round anthropomorphic forms to elicit babylike associations and more angular forms to elicit masculine, aggressive associations.
...
### 9. Aposematism  
<span class="em">The use of conspicuous markings to grab attention and signal danger.</span>
...
<figure  >
  <img src="/Notes/image/bugs - james-wainscoat.jpg" alt="Macro shot of assorted insects on green leaf"/>
  <figcaption>
