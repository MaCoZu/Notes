...
The ﬁrst question that you should always ask about a number is “Compared to what?”
...
<svg viewBox="0 0 600 250" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: auto; max-width: 600px;">

  <g transform="translate(10, 10)">
    <circle cx="50" cy="100" r="10" fill="var(--color-link)" opacity="0.8"/>
    <text x="50" y="170" font-family="Arial" font-size="12" text-anchor="middle"  fill="currentColor"> 1x Area</text>
    <circle cx="150" cy="100" r="40" fill="var(--color-link)" />
    <text x="150" y="170" font-family="Arial" font-size="12"  fill="currentColor" text-anchor="middle">16x Area</text>
  </g>

  <g transform="translate(300, 10)">
    <line x1="20" y1="70" x2="20" y2="165" stroke="black" stroke-width="1" />
    <rect x="20" y="80" width="360" height="30" fill="var(--color-link)"/>
    <text x="180" y="97.5" font-family="Arial" font-size="12"  fill="currentColor" text-anchor="end">16x</text>
    <rect x="20" y="125" width="20" height="30" fill="var(--color-link)" opacity="0.8" />
    <text x="65" y="145" font-family="Arial" font-size="12"  fill="currentColor" text-anchor="end">1x</text>
  </g>
</svg>
...
#### Boxes
Boxes are like bars, except that both ends encode quantitative values. They are used to encode a range of values, usually from the highest to the lowest, rather than a 
