...
1. **Abbe Principle**:  
Align the measuring scale with the distance being measured to eliminate angular errors.
2. **Accessibility**:  
Designs should be usable by as many people as possible without modification.
3. **Ackoff’s Law**:  
Prioritize strategy (doing the right thing) over execution (doing things right).
